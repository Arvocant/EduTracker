...
//       Query qry = ourDB.orderByChild('role').equalTo('student');
//       DataSnapshot snap = await qry.get();

//       if (snap != null && snap.value != null) {
//         Map<dynamic, dynamic> data = snap.value as Map<dynamic, dynamic>;

//         List<Person> allStudents = List<Person>.filled(
//             500, new Person("", "", DateTime.now(), "", "", Role.student),
//             growable: true);
...
//       final DatabaseReference ourDB =
//           FirebaseDatabase.instance.ref().child('users');
//       Query qry = ourDB.orderByChild('role').equalTo('teacher');
//       DataSnapshot snap = await qry.get();
...
//         Person a = Person(ourDB.push().key.toString(), "s102910",
//             DateTime.now(), "John", "Doe", Role.student);
//         Person b = Person(ourDB.push().key.toString(), "p129802",
//             DateTime.now(), "Frieda", "Kroket", Role.teacher);
//         Person c = Person(ourDB.push().key.toString(), "p192831",
//             DateTime.now(), "Thibaut", "Weekx", Role.admin);
//         Person d = Person(ourDB.push().key.toString(), "s120912",
//             DateTime.now(), "Arvo", "Cunt", Role.student);
