...
class _QuestionListState extends State<QuestionList> {
  ...
  Widget build(BuildContext context) {
    ...
    itemBuilder: (context, item) {
      return _buildRow(context, widget.questionItems[item], widget.onClicked);
      }
    );
  }
}

Widget _buildRow(BuildContext context, Question question, Function(Question) onClicked) {
  return Container(
...
pushToQuestion(BuildContext context, Question question) {
  ...
  MaterialPageRoute(
    builder: (context) => //EEN PAGE met question in
    )
  );
}
